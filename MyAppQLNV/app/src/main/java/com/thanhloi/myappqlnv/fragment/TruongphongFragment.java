...
public class TruongphongFragment extends Fragment {
    ...
    private void openDialogAdd(){
        ...
        ArrayList<ChucVu> listCv=cvDao.getAll("TruongPhong");
        ...
        btThem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nvDao.insert(nv)) {
                    ...
                    list.clear();
                    list.addAll(nvDao.getAll("TruongPhong"));
